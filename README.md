...
:technologist: My experiences include using Pentaho and Qlikview to make data extraction while applying R and Python to analise data. Also, I'm always trying to create meaningful data visualization.
